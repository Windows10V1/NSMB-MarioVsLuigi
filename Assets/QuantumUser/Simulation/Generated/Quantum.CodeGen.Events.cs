...
namespace Quantum {
  ...
  public unsafe partial class Frame {
    public unsafe partial struct FrameEvents {
      ...
      static partial void GetEventTypeCodeGen(Int32 eventID, ref System.Type result) {
        switch (eventID) {
          case EventBanzaiBillHitByProjectile.ID: result = typeof(EventBanzaiBillHitByProjectile); return;
          ...
          case EventEnemyPierced.ID: result = typeof(EventEnemyPierced); return;
      ...
      public EventBanzaiBillHitByProjectile BanzaiBillHitByProjectile(EntityRef Entity) {
        var ev = _f.Context.AcquireEvent<EventBanzaiBillHitByProjectile>(EventBanzaiBillHitByProjectile.ID);
        ev.Entity = Entity;
        _f.AddEvent(ev);
        return ev;
      }
      ...
      public EventEnemyPierced EnemyPierced(EntityRef Entity) {
        var ev = _f.Context.AcquireEvent<EventEnemyPierced>(EventEnemyPierced.ID);
        ev.Entity = Entity;
        _f.AddEvent(ev);
        return ev;
      }
  ...
  public unsafe partial class EventBanzaiBillHitByProjectile : EventBase {
    public new const Int32 ID = 1;
    public EntityRef Entity;
    protected EventBanzaiBillHitByProjectile(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventBanzaiBillHitByProjectile() : 
  ...
  public unsafe partial class EventEnemyPierced : EventBase {
    public new const Int32 ID = 23;
    public EntityRef Entity;
    protected EventEnemyPierced(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventEnemyPierced() : 
