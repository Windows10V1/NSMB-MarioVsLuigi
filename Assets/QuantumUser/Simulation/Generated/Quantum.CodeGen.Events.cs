...
namespace Quantum {
    ...
    public unsafe partial struct FrameEvents {
      ...
      static partial void GetEventTypeCodeGen(Int32 eventID, ref System.Type result) {
        switch (eventID) {
          ...
          case EventFrogSuitBounce.ID: result = typeof(EventFrogSuitBounce); return;
          ...
          case EventMarioPlayerStatueActivated.ID: result = typeof(EventMarioPlayerStatueActivated); return;
          ...
          case EventPOWBlockSpawnLanded.ID: result = typeof(EventPOWBlockSpawnLanded); return;
      ...
      public EventFrogSuitBounce FrogSuitBounce(EntityRef Entity) {
        var ev = _f.Context.AcquireEvent<EventFrogSuitBounce>(EventFrogSuitBounce.ID);
        ev.Entity = Entity;
        _f.AddEvent(ev);
        return ev;
      }
      ...
      public EventProjectileHitPlayer ProjectileHitPlayer(EntityRef Entity, ProjectileEffectType Effect) {
      ...
      public EventMarioPlayerStatueActivated MarioPlayerStatueActivated(EntityRef Entity) {
        var ev = _f.Context.AcquireEvent<EventMarioPlayerStatueActivated>(EventMarioPlayerStatueActivated.ID);
        ev.Entity = Entity;
        _f.AddEvent(ev);
        return ev;
      }
      ...
      public EventPOWBlockSpawnLanded POWBlockSpawnLanded(EntityRef Entity, FPVector2 Position) {
        var ev = _f.Context.AcquireEvent<EventPOWBlockSpawnLanded>(EventPOWBlockSpawnLanded.ID);
        ev.Entity = Entity;
        ev.Position = Position;
        _f.AddEvent(ev);
        return ev;
  ...
  public unsafe partial class EventFrogSuitBounce : EventBase {
    public new const Int32 ID = 25;
    public EntityRef Entity;
    protected EventFrogSuitBounce(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventFrogSuitBounce() : 
  ...
  public unsafe partial class EventMarioPlayerStatueActivated : EventBase {
    public new const Int32 ID = 72;
    public EntityRef Entity;
    protected EventMarioPlayerStatueActivated(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventMarioPlayerStatueActivated() : 
  ...
  public unsafe partial class EventPOWBlockSpawnLanded : EventBase {
    public new const Int32 ID = 79;
    public EntityRef Entity;
    public FPVector2 Position;
    protected EventPOWBlockSpawnLanded(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventPOWBlockSpawnLanded() : 
