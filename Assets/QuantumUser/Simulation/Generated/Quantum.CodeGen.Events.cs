...
namespace Quantum {
    ...
    public unsafe partial struct FrameEvents {
      ...
      static partial void GetEventTypeCodeGen(Int32 eventID, ref System.Type result) {
        switch (eventID) {
          ...
          case EventCloudBlockSquished.ID: result = typeof(EventCloudBlockSquished); return;
          case EventCloudBlockHardSquished.ID: result = typeof(EventCloudBlockHardSquished); return;
          case EventCloudBlockDestroyed.ID: result = typeof(EventCloudBlockDestroyed); return;
          ...
          case EventMarioPlayerSummonedCloudBlock.ID: result = typeof(EventMarioPlayerSummonedCloudBlock); return;
          case EventProjectileHitPlayer.ID: result = typeof(EventProjectileHitPlayer); return;
          ...
          case EventMarioPlayerPenguinSlideStarted.ID: result = typeof(EventMarioPlayerPenguinSlideStarted); return;
          case EventMarioPlayerPenguinSlideStopped.ID: result = typeof(EventMarioPlayerPenguinSlideStopped); return;
          ...
          case EventPOWBlockActivated.ID: result = typeof(EventPOWBlockActivated); return;
      ...
      public EventCloudBlockSquished CloudBlockSquished(EntityRef Entity) {
        var ev = _f.Context.AcquireEvent<EventCloudBlockSquished>(EventCloudBlockSquished.ID);
        ev.Entity = Entity;
        _f.AddEvent(ev);
        return ev;
      }
      public EventCloudBlockHardSquished CloudBlockHardSquished(EntityRef Entity) {
        var ev = _f.Context.AcquireEvent<EventCloudBlockHardSquished>(EventCloudBlockHardSquished.ID);
        ev.Entity = Entity;
        _f.AddEvent(ev);
        return ev;
      }
      public EventCloudBlockDestroyed CloudBlockDestroyed(EntityRef Entity, FPVector2 Position) {
        var ev = _f.Context.AcquireEvent<EventCloudBlockDestroyed>(EventCloudBlockDestroyed.ID);
        ev.Entity = Entity;
        ev.Position = Position;
        _f.AddEvent(ev);
        return ev;
      ...
      public EventMarioPlayerSummonedCloudBlock MarioPlayerSummonedCloudBlock(EntityRef Entity) {
        var ev = _f.Context.AcquireEvent<EventMarioPlayerSummonedCloudBlock>(EventMarioPlayerSummonedCloudBlock.ID);
        ev.Entity = Entity;
        _f.AddEvent(ev);
        return ev;
      }
      public EventProjectileHitPlayer ProjectileHitPlayer(EntityRef Player, ProjectileEffectType Effect) {
        var ev = _f.Context.AcquireEvent<EventProjectileHitPlayer>(EventProjectileHitPlayer.ID);
        ev.Player = Player;
        ev.Effect = Effect;
        _f.AddEvent(ev);
        return ev;
      ...
      public EventMarioPlayerPenguinSlideStarted MarioPlayerPenguinSlideStarted(EntityRef Entity) {
        var ev = _f.Context.AcquireEvent<EventMarioPlayerPenguinSlideStarted>(EventMarioPlayerPenguinSlideStarted.ID);
        ev.Entity = Entity;
        _f.AddEvent(ev);
        return ev;
      }
      public EventMarioPlayerPenguinSlideStopped MarioPlayerPenguinSlideStopped(EntityRef Entity) {
        var ev = _f.Context.AcquireEvent<EventMarioPlayerPenguinSlideStopped>(EventMarioPlayerPenguinSlideStopped.ID);
        ev.Entity = Entity;
        _f.AddEvent(ev);
        return ev;
      }
      ...
      public EventPOWBlockActivated POWBlockActivated(EntityRef Entity, EntityRef Activator, FPVector2 Position, Byte Uses) {
        var ev = _f.Context.AcquireEvent<EventPOWBlockActivated>(EventPOWBlockActivated.ID);
        ev.Entity = Entity;
  ...
  public unsafe partial class EventCloudBlockSquished : EventBase {
    public new const Int32 ID = 13;
    public EntityRef Entity;
    protected EventCloudBlockSquished(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventCloudBlockSquished() : 
  ...
  public unsafe partial class EventCloudBlockHardSquished : EventBase {
    public new const Int32 ID = 14;
    public EntityRef Entity;
    protected EventCloudBlockHardSquished(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventCloudBlockHardSquished() : 
  ...
  public unsafe partial class EventCloudBlockDestroyed : EventBase {
    public new const Int32 ID = 15;
    public EntityRef Entity;
    public FPVector2 Position;
    protected EventCloudBlockDestroyed(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventCloudBlockDestroyed() : 
  ...
  public unsafe partial class EventMarioPlayerSummonedCloudBlock : EventBase {
    public new const Int32 ID = 69;
    public EntityRef Entity;
    protected EventMarioPlayerSummonedCloudBlock(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventMarioPlayerSummonedCloudBlock() : 
  ...
  public unsafe partial class EventProjectileHitPlayer : EventBase {
    public new const Int32 ID = 70;
    public EntityRef Player;
    public ProjectileEffectType Effect;
    protected EventProjectileHitPlayer(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventProjectileHitPlayer() : 
  ...
  public unsafe partial class EventMarioPlayerPenguinSlideStarted : EventBase {
    public new const Int32 ID = 74;
    public EntityRef Entity;
    protected EventMarioPlayerPenguinSlideStarted(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventMarioPlayerPenguinSlideStarted() : 
  ...
  public unsafe partial class EventMarioPlayerPenguinSlideStopped : EventBase {
    public new const Int32 ID = 75;
    public EntityRef Entity;
    protected EventMarioPlayerPenguinSlideStopped(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventMarioPlayerPenguinSlideStopped() : 
  ...
  public unsafe partial class EventPOWBlockActivated : EventBase {
    public new const Int32 ID = 83;
    public EntityRef Entity;
    public EntityRef Activator;
    public FPVector2 Position;
    public Byte Uses;
    protected EventPOWBlockActivated(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventPOWBlockActivated() : 
