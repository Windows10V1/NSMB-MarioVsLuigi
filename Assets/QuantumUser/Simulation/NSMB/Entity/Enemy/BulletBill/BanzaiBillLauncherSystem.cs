...
namespace Quantum {
    public unsafe class BanzaiBillLauncherSystem : SystemMainThreadEntityFilter<BulletBillLauncher, BanzaiBillLauncherSystem.Filter>, ISignalOnComponentRemoved<BulletBill> {
        ...
        public override void Update(Frame f, ref Filter filter, VersusStageData stage) {
            // Skip entities that have BreakableObject (handled by BulletBillLauncherSystem)
            if (f.Unsafe.TryGetPointer(filter.Entity, out BreakableObject* _)) {
                return;
            }
